...
public class MemoRepositoryImpl implements MemoRepository {
    ...
    public void write(Long id, String title, String writer, String password, String contents) {
        ...
        /*memo.setId(id);
        memo.setTitle(title);
        memo.setWritername(writer);
        memo.setWriterpassword(password);
        memo.setContents(contents);
        LocalDate localDate = LocalDate.now();
        memo.setWritedate(localDate);*/
        System.out.println();
    ...
    public void edit(Long id, String title, String writername, String writerpassword, String contents) {
        ...
        /*Memo memo = data.get(id);
        memo.setTitle(title);
        memo.setWritername(writername);
        memo.setWriterpassword(writerpassword);
        memo.setContents(contents);
        LocalDate localDate = LocalDate.now();
        memo.setWritedate(localDate);
        ...
        try
        {
            ...
            preparedStatement.setString(2, memo.getWritername());
            preparedStatement.setString(3, memo.getWriterpassword());
            preparedStatement.setString(4, memo.getContents());
            *//*String writedate = LocalDate.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd"));
            preparedStatement.setString(5, writedate);*//*
            preparedStatement.setDate(5, java.sql.Date.valueOf(memo.getWritedate()));
            preparedStatement.setLong(6, memo.getId());
